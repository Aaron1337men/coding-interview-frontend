import 'package:crypto_calculator/utils/scroll_pagination_utils.dart';
...
class AIBInfiniteScroll<T> extends StatefulWidget {
  const AIBInfiniteScroll({
  ...
  @override
  State createState() => _AIBInfiniteScrollState<T>();

  static int initialPage = 1;
}

class _AIBInfiniteScrollState<T> extends State<AIBInfiniteScroll<T>> {
  ...
  void initState() {
    _pagingController = widget.controller ??
        PagingController(
          firstPageKey: AIBInfiniteScroll.initialPage,
        );
